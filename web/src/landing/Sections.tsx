    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <Reveal from={{ y: 40 }} delay={0.1} duration={0.8}>
          <h2 className="font-display-serif m-0 mt-6 max-w-4xl text-4xl leading-[1.1] tracking-tight text-white md:text-6xl lg:text-7xl">
            Comparing two policies costs a person{" "}
            <em className="italic text-white/60">a week standing next to an arm.</em>
          </h2>
        </Reveal>

        <ul className="m-0 mt-14 grid list-none grid-cols-1 gap-px overflow-hidden rounded-3xl bg-white/10 p-0 sm:grid-cols-2 lg:grid-cols-4">
...
function RateBar({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <span className="font-mono text-[0.6875rem] leading-relaxed text-white/55">{sublabel}</span>
    </div>
  );
}
  ...
  return (
    <section id="called-shot" className="relative overflow-hidden bg-black px-6 py-24 md:py-32">
      <div className="relative mx-auto max-w-6xl">
        ...
        <Reveal from={{ y: 40 }} delay={0.1} duration={0.8}>
          <h2 className="font-display-serif m-0 mt-6 max-w-4xl text-4xl leading-[1.1] tracking-tight text-white md:text-6xl">
            The cheap substitute is{" "}
            <em className="italic text-white/60">eighty-eight points wrong.</em>
          </h2>
        </Reveal>
        ...
        <Reveal from={{ y: 60 }} delay={0.12} duration={0.9} className="mt-12">
          <div className="relative aspect-video overflow-hidden rounded-3xl">
            ...
            <div className="absolute inset-x-0 bottom-0 flex flex-col gap-6 p-6 md:flex-row md:items-end md:justify-between md:p-10">
              <Glass className="max-w-md rounded-2xl p-6 md:p-8">
                <p className="m-0 text-xs uppercase tracking-[0.18em] text-white/60">Our approach</p>
                <p className="m-0 mt-3 text-sm leading-relaxed text-white md:text-base">
                  The validity gate is Python, not a model call. We took the work away from the
                  model.
                </p>
              </Glass>
              <Glass className="self-start rounded-full md:self-auto">
                <Link
                  to={RESULTS_PATH}
        ...
        <Reveal from={{ y: 40 }} delay={0.15} duration={0.8} className="mt-8">
          <Glass className="rounded-3xl p-6 md:p-10">
            <div className="flex flex-wrap items-baseline justify-between gap-4">
              <p className="m-0 font-mono text-sm text-white/80">
                {CALLED_SHOT.policy} · “{CALLED_SHOT.task}”
              </p>
              <p className="m-0 font-mono text-xs uppercase tracking-[0.18em] text-white/55">
                50 trials per cell
              </p>
            </div>
            ...
            <p className="m-0 mt-8 text-sm leading-relaxed text-white/70 md:text-base">
    ...
    <section id="pipeline" className="relative overflow-hidden bg-black px-6 py-24 md:py-36">
      <div className="relative mx-auto max-w-6xl">
        <Reveal from={{ y: 40 }} duration={0.8}>
          <h2 className="font-display-serif m-0 text-4xl leading-[1.05] tracking-tight text-white md:text-6xl lg:text-7xl">
            Four steps, <em className="italic text-white/50">four</em> hardware profiles.
          </h2>
        </Reveal>
              ...
              <ol className="relative m-0 flex list-none flex-col gap-6 p-0">
                ...
                {CHAIN_STEPS.map((step, index) => (
                  <li key={step.id} className="relative flex gap-5 pl-0">
                    <span
                      aria-hidden="true"
                      className="relative z-10 mt-1 grid size-6 shrink-0 place-items-center rounded-full bg-black font-mono text-[0.6875rem] text-white/80 ring-1 ring-white/20"
                    >
                      {index + 1}
                    </span>
                    <div>
                      <p className="m-0 text-base font-medium text-white">{step.name}</p>
                      <p className="m-0 mt-1 font-mono text-[0.6875rem] uppercase tracking-[0.14em] text-accent-bright">
                        {step.hardware}
                      </p>
                      <p className="m-0 mt-2 text-sm leading-relaxed text-white/70">{step.detail}</p>
                    </div>
                  </li>
                ))}
              </ol>
        ...
        <div className="mt-8 grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-12">
          <Reveal from={{ x: -40 }} duration={0.8}>
            <VideoPanel src={VIDEO.pipeline} className="aspect-[4/3] w-full rounded-3xl" />
          </Reveal>
            ...
            <div className="flex flex-col gap-10">
              ...
              <div className="flex flex-col gap-4">
                ...
                <ul className="m-0 flex list-none flex-wrap gap-2 p-0">
                  {TASKS.map((task) => (
                    <li key={task.prompt}>
                      <span className="inline-flex items-center gap-2 rounded-full border border-white/15 px-3.5 py-1.5 font-mono text-[0.6875rem] text-white/80">
                        {task.prompt}
                        <span className="text-white/55">{task.horizon} steps</span>
                      </span>
                    </li>
                  ))}
                </ul>
      ...
      <div className="relative mx-auto max-w-6xl">
        <Reveal from={{ y: 30 }} duration={0.7}>
          <div className="flex flex-wrap items-end justify-between gap-4">
            <h2 className="font-display-serif m-0 text-3xl tracking-tight text-white md:text-5xl">
              The four numbers we publish about ourselves
            </h2>
            <p className="m-0 hidden text-sm text-white/60 md:block">The spec sheet</p>
          </div>
        </Reveal>

        <Reveal from={{ y: 20 }} delay={0.08} duration={0.6}>
          <p className="m-0 mt-6 max-w-2xl text-base leading-relaxed text-white/70">
          ...
          {FOUR_NUMBERS.map((item, index) => (
            <li key={item.title}>
              <Reveal from={{ y: 50 }} delay={index * 0.15} duration={0.8} className="h-full">
                <Glass className="group flex h-full flex-col rounded-3xl p-6 md:p-8">
                  ...
                  <p className="m-0 mt-3 flex-1 text-sm leading-relaxed text-white/70">
                    {item.description}
                  </p>
                  <div className="mt-6 border-t border-white/10 pt-5">
                    <dl className="m-0 flex items-baseline justify-between gap-4">
                      <dt className="m-0 text-xs uppercase tracking-[0.14em] text-white/60">
                        Value
                      </dt>
                    ...
                    <p className="m-0 mt-2 text-[0.6875rem] leading-relaxed text-white/55">
                      {item.priorArt}
                    </p>
                  </div>
                </Glass>
      ...
      <div className="relative mx-auto max-w-6xl">
        <Reveal from={{ y: 30 }} duration={0.7}>
          <div className="flex flex-wrap items-end justify-between gap-4">
            ...
            <p className="m-0 hidden text-sm text-white/60 md:block">Two halves, in order</p>
          </div>
        </Reveal>
        ...
        <ul className="m-0 mt-12 grid list-none grid-cols-1 gap-6 p-0 md:grid-cols-2 md:gap-8">
          {SERVICES.map((service, index) => (
            <li key={service.title}>
              <Reveal from={{ y: 50 }} delay={index * 0.15} duration={0.8} className="h-full">
                <Glass className="group flex h-full flex-col overflow-hidden rounded-3xl">
                  ...
                  <div className="flex flex-1 flex-col p-6 md:p-8">
                    ...
                    <p className="m-0 mt-3 text-sm leading-relaxed text-white/70">{service.body}</p>
                  </div>
                </Glass>
              </Reveal>
            </li>
    ...
    <section id="stack" className="relative overflow-hidden bg-black px-6 py-24 md:py-32">
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="mt-6 grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.15fr)] lg:gap-16">
          <Reveal from={{ y: 40 }} delay={0.1} duration={0.8}>
            <h2 className="font-display-serif m-0 text-4xl leading-[1.1] tracking-tight text-white md:text-5xl">
              Everything ungated. <em className="italic text-white/60">Nothing waits on a human.</em>
            </h2>
            <p className="m-0 mt-6 text-base leading-relaxed text-white/70">
              ...
              <code className="font-mono text-white/80">async_queue_status</code>.
            </p>

            <Glass className="mt-8 rounded-3xl p-6 md:p-8">
              <p className="m-0 text-xs uppercase tracking-[0.18em] text-white/60">
                The burst, on stage
              </p>
              <p className="m-0 mt-4 font-display-serif text-3xl leading-tight text-white md:text-4xl">
                {BURST_TARGET.episodes.toLocaleString("en-US")} rollouts in{" "}
                {BURST_TARGET.seconds} seconds for ${BURST_TARGET.usd.toFixed(2)}
              </p>
              <p className="m-0 mt-4 text-sm leading-relaxed text-white/70">
          ...
          <Reveal from={{ y: 40 }} delay={0.2} duration={0.8}>
            <ul className="m-0 flex list-none flex-col p-0">
              {STACK.map((row) => (
                ...
                >
                  <span className="font-mono text-[0.6875rem] uppercase tracking-[0.14em] text-white/60">
                    {row.layer}
                  </span>
                  <span>
                    <span className="block font-mono text-sm text-white">{row.choice}</span>
  ...
  return (
    <section id="limits" className="relative overflow-hidden bg-black px-6 py-24 md:py-32">
      <div className="relative mx-auto max-w-6xl">
        ...
        <Reveal from={{ y: 40 }} delay={0.1} duration={0.8}>
          <h2 className="font-display-serif m-0 mt-6 max-w-3xl text-4xl leading-[1.1] tracking-tight text-white md:text-5xl">
            Goalposts we cannot move <em className="italic text-white/60">until we cross them.</em>
          </h2>
        </Reveal>

        <ul className="m-0 mt-12 grid list-none grid-cols-1 gap-px overflow-hidden rounded-3xl bg-white/10 p-0 md:grid-cols-2">
          {LIMITS.map((limit, index) => (
            <li key={limit.title} className="bg-black">
              <Reveal from={{ y: 30 }} delay={index * 0.08} duration={0.7} className="h-full">
                <div className="h-full p-6 md:p-8">
                  <h3 className="m-0 text-lg tracking-tight text-white">{limit.title}</h3>
                  <p className="m-0 mt-3 text-sm leading-relaxed text-white/70">{limit.body}</p>
                </div>
              </Reveal>
            </li>
          ))}
  ...
  return (
    <section className="relative overflow-hidden bg-black px-6 pb-24 pt-16 md:pb-32 md:pt-24">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        <Reveal from={{ y: 40 }} duration={0.8}>
          <h2 className="font-display-serif m-0 text-4xl leading-[1.05] tracking-tight text-white md:text-6xl lg:text-7xl">
            We measured the ruler <em className="italic text-white/60">before we trusted it.</em>
          </h2>
          <p className="m-0 mt-6 text-base leading-relaxed text-white/70 md:text-lg">
    ...
    <footer className="border-t border-white/10 bg-black px-6 py-10">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="m-0 mt-1 text-[0.6875rem] text-white/55">
        ...
        <ul className="m-0 flex list-none flex-wrap gap-6 p-0 text-sm">
          <li>
            <Link className="text-white/70 no-underline hover:text-white" to={CONSOLE_PATH}>
              Console
            </Link>
          </li>
          <li>
            <Link className="text-white/70 no-underline hover:text-white" to={LIVE_PATH}>
              Live run
            </Link>
          </li>
          <li>
